...
const AdminPage = () => {
    ...
    // Stats
    const [stats, setStats] = useState({ totalJournals: 0, totalAdmins: 0, totalLogs: 0, totalDepartments: 0, department: null });
    ...
    const statCards = isSuperAdmin() ? [
        { title: "Total Publications", value: stats.totalJournals, icon: FileText, bg: "bg-blue-50", text: "text-blue-600" },
        ...
        { title: `${stats.department || 'Dept'} Publications`, value: stats.totalJournals, icon: FileText, bg: "bg-blue-50", text: "text-blue-600" },
